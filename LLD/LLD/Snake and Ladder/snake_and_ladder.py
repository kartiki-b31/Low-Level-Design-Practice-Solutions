...
# Board Class
class Board:
    BOARD_SIZE = 100 #class variables in capitals.
    ...
    def play(self):
        while not self._is_game_over():
            ...
            if new_position > self.board.get_board_size():
                print(f"{current_player.get_name()} rolled a {dice_roll} and this Exceeds the Board Size, so no change in the position")
